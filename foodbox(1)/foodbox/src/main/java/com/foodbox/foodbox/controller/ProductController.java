...
import com.foodbox.foodbox.exception.ResourceNotFoundException;
...
public class ProductController {
    ...
    public List<Product> getAllProducts() {
        ...
        if(prodList.isEmpty()) {
            ...
            addProdIfEmpty(new Product(1,"Butter Tofu","Tofu infused with butter and spices","Indian",350,0,0,"yes","./assets/images/ButterChicken.png"));
            addProdIfEmpty(new Product(2,"Biryani","Rice Steamed with Vegetables and spices","Indian",365,10,0,"yes","./assets/images/biryani.jpg"));
            addProdIfEmpty(new Product(3,"Steamed Mince Burger","Steamed Bun with Veggie mince","Chinese",250,20,0,"yes","./assets/images/buns.jpg"));
            addProdIfEmpty(new Product(4,"Fried Rice","Rice with Egg and Chinese sauses","Chinese",95,5,0,"yes","./assets/images/EggfriedRice.jpg"));
            ...
            addProdIfEmpty(new Product(2,"Burrito","Wrapped Tortilla with mince and Mayo","Mexican",350,0,0,"yes","./assets/images/Burrito.jpg"));
